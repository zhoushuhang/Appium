...
driver.find_element_by_id("com.cloudbae.lovenanning:id/etInputPhoneNum").send_keys("176****5072")
driver.find_element_by_id("com.cloudbae.lovenanning:id/etInputPwd").send_keys("*******")
